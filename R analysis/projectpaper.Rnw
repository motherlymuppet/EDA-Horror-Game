...
Some experiments have attempted to use biofeedback to control the scares in horror games, but all have shown significant flaws in their approach or choice of sensor.
...
The user experience will be measured in terms of self-reported enjoyment, in addition to emprical data from the sensor indicating how effective each scare was.
A secondary aim of the project is to simplify the development of horror games by removing the need to pre-program scare locations in an environment.
